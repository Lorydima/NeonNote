# NeonNote — Source-Available License

This license applies to NeonNote latest version and all future versions of the software.
...
You must accept the license terms in order to use NeonNote. If you do not accept, the program will not run.  
